...
from qai_hub_models.models.intern3_5_vl_4b import (
    MODEL_ID,
    VisionEncoder,
)
from qai_hub_models.models.intern3_5_vl_4b.demo import (
    intern3_5_vl_4b_chat_demo,
)
from qai_hub_models.models.intern3_5_vl_4b.model import (
...
def test_load_encodings_to_quantsim(checkpoint: str) -> None:
    Intern3_5_VL_4B_PreSplit.release()
    Intern3_5_VL_4B_QuantizablePreSplit.release()
    Intern3_5_VL_4B_QuantizablePreSplit.from_pretrained(checkpoint=checkpoint)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("DEFAULT", "wikitext", 10.87, 0, marks=pytest.mark.nightly),
        ("DEFAULT", "mmlu", 0.7080, 1000),
        ("DEFAULT", "mmmu", 0.57, 200),
        ...
        ("DEFAULT_UNQUANTIZED", "wikitext", 10.51, 0),
        ("DEFAULT_UNQUANTIZED", "mmlu", 0.736, 1000),
        ("DEFAULT_UNQUANTIZED", "mmmu", 0.59, 200),
    ],
)
def test_evaluate(
    checkpoint: str,
    ...
    dataset_cls = next(
        d
        for d in Intern3_5_VL_4B_PreSplit.get_eval_dataset_classes()
    ...
    test.run_llm_evaluate_test(
        ...
        quantized_split_cls=Intern3_5_VL_4B_QuantizablePreSplit,
        fp_split_cls=Intern3_5_VL_4B_PreSplit,
        quantized_presplit_cls=Intern3_5_VL_4B_QuantizablePreSplit,
...
def test_demo_default(
    ...
    Intern3_5_VL_4B_PreSplit.release()
    Intern3_5_VL_4B_QuantizablePreSplit.release()
    intern3_5_vl_4b_chat_demo(test_checkpoint=checkpoint)
