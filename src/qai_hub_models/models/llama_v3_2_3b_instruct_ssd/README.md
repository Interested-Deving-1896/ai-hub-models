...
qai-hub-models install llama_v3_2_3b_instruct_ssd
```
...
```bash
qai-hub-models demo llama_v3_2_3b_instruct_ssd
```
...
```bash
qai-hub-models export llama_v3_2_3b_instruct_ssd --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export llama_v3_2_3b_instruct_ssd --checkpoint ./quantized_checkpoint
```
