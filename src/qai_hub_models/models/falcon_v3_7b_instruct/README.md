...
qai-hub-models install falcon_v3_7b_instruct
```
...
```bash
qai-hub-models demo falcon_v3_7b_instruct
```
...
```bash
qai-hub-models export falcon_v3_7b_instruct --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export falcon_v3_7b_instruct --checkpoint ./quantized_checkpoint
```
