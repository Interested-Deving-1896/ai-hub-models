...
qai-hub-models install qwen3_4b_instruct_2507
```
...
```bash
qai-hub-models demo qwen3_4b_instruct_2507
```
...
```bash
qai-hub-models export qwen3_4b_instruct_2507 --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export qwen3_4b_instruct_2507 --checkpoint ./quantized_checkpoint
```
