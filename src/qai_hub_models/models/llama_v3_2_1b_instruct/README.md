...
qai-hub-models install llama_v3_2_1b_instruct
```
...
```bash
qai-hub-models demo llama_v3_2_1b_instruct
```
...
```bash
qai-hub-models export llama_v3_2_1b_instruct --checkpoint DEFAULT_W4
```
...
qai-hub-models export llama_v3_2_1b_instruct --checkpoint ./quantized_checkpoint
```
