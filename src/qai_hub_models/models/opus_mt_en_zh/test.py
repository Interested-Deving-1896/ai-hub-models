...
from qai_hub_models.models.opus_mt_en_zh.demo import main as demo_main
from qai_hub_models.models.opus_mt_en_zh.model import (
    OpusMTEnZh,
)
...
def test_tokenizer() -> None:
    ...
    model = OpusMTEnZh.from_pretrained()
