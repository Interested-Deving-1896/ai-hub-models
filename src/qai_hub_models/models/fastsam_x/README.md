...
Use our lightweight command-line interface to inspect FastSam-X:
...
qai-hub-models install fastsam_x
```
...
```bash
python -m qai_hub_models.models.fastsam_x.demo { --quantize w8a16_mixed_int16, w8a16 }
```
