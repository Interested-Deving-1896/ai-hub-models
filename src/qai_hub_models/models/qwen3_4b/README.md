...
qai-hub-models install qwen3_4b
```
...
```bash
qai-hub-models export qwen3_4b --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export qwen3_4b --checkpoint ./quantized_checkpoint
```
