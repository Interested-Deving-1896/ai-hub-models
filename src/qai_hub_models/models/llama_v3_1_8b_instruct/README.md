...
qai-hub-models install llama_v3_1_8b_instruct
```
...
```bash
qai-hub-models demo llama_v3_1_8b_instruct
```
...
```bash
qai-hub-models export llama_v3_1_8b_instruct --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export llama_v3_1_8b_instruct --checkpoint ./quantized_checkpoint
```
