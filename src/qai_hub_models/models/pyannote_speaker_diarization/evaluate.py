...
from qai_hub_models.models.pyannote_speaker_diarization import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.pyannote_speaker_diarization.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate pyannote_speaker_diarization` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
