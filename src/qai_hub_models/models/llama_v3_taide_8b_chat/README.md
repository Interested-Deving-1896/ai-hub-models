...
qai-hub-models install llama_v3_taide_8b_chat
```
...
```bash
qai-hub-models demo llama_v3_taide_8b_chat
```
...
```bash
qai-hub-models export llama_v3_taide_8b_chat --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export llama_v3_taide_8b_chat --checkpoint ./quantized_checkpoint
```
