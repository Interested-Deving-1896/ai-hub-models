...
Use our lightweight command-line interface to inspect Unet-Segmentation:
...
qai-hub-models install unet_segmentation
```
...
```bash
qai-hub-models demo unet_segmentation
```
...
```bash
qai-hub-models export unet_segmentation
```
