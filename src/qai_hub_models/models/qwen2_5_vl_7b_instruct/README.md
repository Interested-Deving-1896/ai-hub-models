...
qai-hub-models install qwen2_5_vl_7b_instruct
```
...
```bash
qai-hub-models demo qwen2_5_vl_7b_instruct
```
...
qai-hub-models export qwen2_5_vl_7b_instruct --checkpoint ./quantized_checkpoint
```
