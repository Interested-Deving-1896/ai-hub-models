...
from qai_hub_models.models.gemma_4_e2b_it import DEFAULT_PRECISION, MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.gemma_4_e2b_it.export` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models export gemma_4_e2b_it` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
