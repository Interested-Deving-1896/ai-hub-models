...
from qai_hub_models.models.wedetect import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.wedetect.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate wedetect` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
