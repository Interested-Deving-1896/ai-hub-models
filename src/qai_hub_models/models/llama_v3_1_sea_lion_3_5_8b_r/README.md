...
qai-hub-models install llama_v3_1_sea_lion_3_5_8b_r
```
...
```bash
qai-hub-models demo llama_v3_1_sea_lion_3_5_8b_r
```
...
```bash
qai-hub-models export llama_v3_1_sea_lion_3_5_8b_r --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export llama_v3_1_sea_lion_3_5_8b_r --checkpoint ./quantized_checkpoint
```
