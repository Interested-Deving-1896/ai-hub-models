...
```bash
qai-hub-models demo llama_v3_elyza_jp_8b
```
...
```bash
qai-hub-models export llama_v3_elyza_jp_8b --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export llama_v3_elyza_jp_8b --checkpoint ./quantized_checkpoint
```
