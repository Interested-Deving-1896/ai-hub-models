...
# ---------------------------------------------------------------------
"""
Reusable template base code for AI Hub Models.

Each subfolder is a node in an acyclic dependency graph (DAG). Folders may
depend on other template folders but must not form cycles.

Folders with dependencies contain a manifest.yaml listing their direct
template folder dependencies (templates: key). Folders without dependencies
have no manifest.
