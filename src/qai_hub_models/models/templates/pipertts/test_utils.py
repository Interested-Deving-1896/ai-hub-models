...
from qai_hub_models.models.templates.hf_whisper.model import HfWhisper
from qai_hub_models.models.templates.pipertts.app import DEFAULT_TEXTS, PiperTTSApp
from qai_hub_models.models.templates.voiceai_tts.test_utils import (
    assert_transcription_matches,
)

if TYPE_CHECKING:
    from qai_hub_models.models.templates.pipertts.model import PiperTTS
