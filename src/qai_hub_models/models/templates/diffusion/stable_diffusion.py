...
from qai_hub_models.models.templates.diffusion import utils
from qai_hub_models.models.templates.diffusion.model_adaptation import (
...
class TextEncoderQuantizableBase(AIMETOnnxQuantizableMixin, TextEncoderBase):
    ...
    def get_calibration_dataset_cls(self) -> type[BaseDataset]:
        from qai_hub_models.models.templates.diffusion.dataset import (
