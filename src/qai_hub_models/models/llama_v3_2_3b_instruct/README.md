...
qai-hub-models install llama_v3_2_3b_instruct
```
...
```bash
qai-hub-models export llama_v3_2_3b_instruct --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export llama_v3_2_3b_instruct --checkpoint ./quantized_checkpoint
```
