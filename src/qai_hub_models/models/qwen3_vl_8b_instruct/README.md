...
qai-hub-models install qwen3_vl_8b_instruct
```
...
```bash
qai-hub-models demo qwen3_vl_8b_instruct
```
...
```bash
qai-hub-models export qwen3_vl_8b_instruct --checkpoint DEFAULT_W4A16
```
...
qai-hub-models export qwen3_vl_8b_instruct --checkpoint ./quantized_checkpoint
```
