...
from qai_hub_models.models.mobilenet_v4 import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.mobilenet_v4.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate mobilenet_v4` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
