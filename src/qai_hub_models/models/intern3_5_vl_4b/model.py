...
# Model architecture constants (from OpenGVLab/InternVL3_5-4B llm_config)
NUM_LAYERS = 36
NUM_SPLITS = 5
...
# Vision encoder configuration (from OpenGVLab/InternVL3_5-4B vision_config)
...
# Hugging Face repo
HF_REPO_NAME = "OpenGVLab/InternVL3_5-4B"
...
DEFAULT_CHECKPOINT: dict = {
    Precision.w4a16: "intern3_5_vl_4b",
}
...
SPLIT_MODEL_NAME = "Intern3_5_VL_4B"


class Intern3_5_VL_4B_PreSplit(Intern3_5VLPreSplitBase):
    """FP PreSplit for InternVL3.5-4B."""
...
class Intern3_5_VL_4B_QuantizablePreSplit(
    Intern3_5VLQuantizablePreSplitBase[Intern3_5_VL_4B_PreSplit]
):
    """Quantizable PreSplit for InternVL3.5-4B."""

    FPModel = Intern3_5_VL_4B_PreSplit
    _hf_repo_name = HF_REPO_NAME
...
class Intern3_5_VL_4B_VisionEncoder(Intern3_5VLVisionEncoderBase):
    """Vision encoder for InternVL3.5-4B (adapted VEG for on-device deployment)."""
    ...
    quant_presplit_cls = Intern3_5_VL_4B_QuantizablePreSplit


Intern3_5_VL_4B_QuantizablePreSplit.vision_encoder_cls = Intern3_5_VL_4B_VisionEncoder


class Intern3_5_VL_4B_PartBase(Intern3_5VLPartBase):
    """Unified Part base for InternVL3.5-4B."""
    ...
    default_precision = DEFAULT_PRECISION
    default_num_visual_tokens = DEFAULT_NUM_VISUAL_TOKENS
    fp_presplit_cls = Intern3_5_VL_4B_PreSplit
    quant_presplit_cls = Intern3_5_VL_4B_QuantizablePreSplit
    export_sequence_lengths = DEFAULT_EXPORT_SEQUENCE_LENGTHS
    export_context_lengths = DEFAULT_EXPORT_CONTEXT_LENGTHS


class Intern3_5_VL_4B_Part1_Of_5(Intern3_5_VL_4B_PartBase):
    part_id = 1


class Intern3_5_VL_4B_Part2_Of_5(Intern3_5_VL_4B_PartBase):
    part_id = 2


class Intern3_5_VL_4B_Part3_Of_5(Intern3_5_VL_4B_PartBase):
    part_id = 3


class Intern3_5_VL_4B_Part4_Of_5(Intern3_5_VL_4B_PartBase):
    part_id = 4


class Intern3_5_VL_4B_Part5_Of_5(Intern3_5_VL_4B_PartBase):
    part_id = 5
...
class FPSplitModelWrapper(Intern3_5VLSplitForwardMixin, Intern3_5_VL_4B_PreSplit):
...
class QuantizedSplitModelWrapper(  # type: ignore[misc]
    Intern3_5VLSplitForwardMixin, Intern3_5_VL_4B_QuantizablePreSplit
):
...
class Intern3_5_VL_4B_Collection(Intern3_5VLCollectionBase):
    """Collection model for InternVL3.5-4B deployment.

    Combines 5 text parts + 1 vision encoder for full VLM deployment.
    """

    _hf_repo_name = HF_REPO_NAME
    fp_presplit_cls = Intern3_5_VL_4B_PreSplit
    quant_presplit_cls = Intern3_5_VL_4B_QuantizablePreSplit
    part_base_cls = Intern3_5_VL_4B_PartBase
    vision_encoder_cls = Intern3_5_VL_4B_VisionEncoder
    num_deepstack_layers = NUM_DEEPSTACK_LAYERS
    vision_patch_size = VISION_PATCH_SIZE
    default_image_height = DEFAULT_IMAGE_HEIGHT
    default_image_width = DEFAULT_IMAGE_WIDTH
    ...
    parts = {
        "part1_of_5": Intern3_5_VL_4B_Part1_Of_5,
        "part2_of_5": Intern3_5_VL_4B_Part2_Of_5,
        "part3_of_5": Intern3_5_VL_4B_Part3_Of_5,
        "part4_of_5": Intern3_5_VL_4B_Part4_Of_5,
        "part5_of_5": Intern3_5_VL_4B_Part5_Of_5,
    }
