...
from qai_hub_models.models.intern3_5_vl_4b import DEFAULT_PRECISION, MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.intern3_5_vl_4b.export` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models export intern3_5_vl_4b` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
