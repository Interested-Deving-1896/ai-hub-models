...
from qai_hub_models.models.srgan import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.srgan.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate srgan` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
